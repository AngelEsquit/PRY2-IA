...
Las siguientes figuras muestran tres escenarios distintos visualizando las diferencias entre algoritmos. Cada escenario se presenta en dos figuras separadas para mantener el tamaño legible de los detalles internos.
...
\label{fig:scenario_example_01_prim}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../reports/problema3/kruskal/scenarios/scenario_01/02_comparison.png}
\caption{Escenario 1 (Kruskal)}
\label{fig:scenario_example_01_kruskal}
\end{figure}
...
\label{fig:scenario_example_10_prim}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../reports/problema3/kruskal/scenarios/scenario_10/02_comparison.png}
\caption{Escenario 10 (Kruskal)}
\label{fig:scenario_example_10_kruskal}
\end{figure}
...
\label{fig:scenario_example_25_prim}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../reports/problema3/kruskal/scenarios/scenario_25/02_comparison.png}
\caption{Escenario 25 (Kruskal)}
\label{fig:scenario_example_25_kruskal}
\end{figure}
...
% Sección "Compliance con Requisitos" eliminada por petición del autor.
