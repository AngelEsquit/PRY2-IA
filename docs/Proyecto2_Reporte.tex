...
Implementar ≥2 algoritmos MST & \checkmark \\
...
Restricción Manhattan ≥10 & \checkmark \\
...
│   ├── maze/
│   │   ├── grid.py             # Representación de laberintos
...
│   └── experiments/
│       └── compare.py          # Comparación y ranking
├── scripts/
│   └── run_all.py              # Script de ejecución
├── tests/
│   ├── test_baseline.py        # Pruebas unitarias
│   └── test_compare.py         # Pruebas de comparación
└── reports/
